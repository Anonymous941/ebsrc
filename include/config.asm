...
; changes name size on the naming screen, requires deletion of saves
.IF .DEFINED(JPN)
	.DEFINE CHAR_NAME_SIZE 4
.ELSE
	.DEFINE CHAR_NAME_SIZE 10
.ENDIF
.DEFINE NON_CHAR_NAME_SIZE 10

; these should the same size, or Don't care will be messed up
.DEFINE PET_NAME_SIZE NON_CHAR_NAME_SIZE
.DEFINE FAVORITE_FOOD_SIZE NON_CHAR_NAME_SIZE
.DEFINE FAVORITE_THING_SIZE NON_CHAR_NAME_SIZE

; length of individual names
.DEFINE DONTCARE_NAME_LENGTH 6
; length of each character's list
.DEFINE DONTCARE_LIST_LENGTH 7
